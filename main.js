...
class Player {
    ...
    printPlayer() {
        ...
        console.log('\n'); // not part of the assignment, but I REALLY hated 
                           // how there was literally 0 spacing between lines
    }
}
...
// from: hhtps://dev.to/codebubb/how-to-shuffle-an-array-in-javascript-21kj
// adapter to JS and reconfigured to return a new (non-mutated) array
...
// Could use JS Array method 'reduce()' to do exactly what code does below
